...
class RuleSearch extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            rule:
            [   {carNo:'鲁NA7813',carAddress:'山东省济南市',carTime:'2018-03-08 12:58:30'},
                {carNo:'鲁NA3356',carAddress:'安徽省合肥市',carTime:'2018-03-09 14:55:55'},
                {carNo:'鲁NA1530',carAddress:'安徽省合肥市',carTime:'2018-03-10 08:23:00'},
                {carNo:'鲁NA2336',carAddress:'山东省威海市',carTime:'2018-03-11 23:00:01'}
            ]
        }
    }
    ...
    renderRow(rowData,sectionId,rowId){
        ...
        return (
            <View style={{height:45,width:width,flexDirection:'row',justifyContent:'center',alignItems:'center',paddingHorizontal:10}}>
                ...
                <View style={{flex:1,justifyContent:'center',alignItems:'center',paddingVertical:10}}>
                    <Text style={{fontSize:16,color:'#888'}}>{rowData.carTime}</Text></View>
                <View style={{flex:1,justifyContent:'center',alignItems:'center',paddingVertical:10}}>
