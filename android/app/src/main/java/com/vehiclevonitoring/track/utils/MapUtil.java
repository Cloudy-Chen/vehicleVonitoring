package com.vehiclevonitoring.track.utils;
...
import com.vehiclevonitoring.MainApplication;
import com.vehiclevonitoring.track.model.CurrentLocation;
import java.util.List;

import static com.vehiclevonitoring.track.utils.BitmapUtil.bmArrowPoint;
import static com.vehiclevonitoring.track.utils.BitmapUtil.bmEnd;
import static com.vehiclevonitoring.track.utils.BitmapUtil.bmStart;
...
public class MapUtil {
     ...
     * @param trackApp
     */
    public void setCenter(MainApplication trackApp) {
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > MainApplication.screenHeight - 500
                    || screenPoint.x < 200 || screenPoint.x > MainApplication.screenWidth - 200
                    || null == mapStatus) {
